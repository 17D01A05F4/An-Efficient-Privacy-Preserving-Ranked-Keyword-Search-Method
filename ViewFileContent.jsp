...
.style3 {color: #FF0000}
.style4 {font-size: 36px; color: #FF0000; }
.style6 {font-size: 36px; color: #FF0000; font-weight: bold; }
-->
</style>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
       <h1 align="left"><span class="style6"><a href="index.html" class="style6"><strong>An Efficient Privacy-Preserving Ranked Keyword Search Method</strong></a></span></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
