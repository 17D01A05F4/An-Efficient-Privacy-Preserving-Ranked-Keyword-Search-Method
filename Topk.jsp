...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
       <h1><a href="index.html" class="style5 style6">An Efficient Privacy-Preserving Ranked Keyword Search Method</a><a href="index.html"></a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="Topk1.jsp">
            <p align="center">&nbsp;</p>
            <p align="center"><span class="style8">Enter Top K (Eg.1,2,3 or etc)Value </span>
                <input required="required" name="t14" type="text" value="" size="40" />
            </p>
            <p align="center">
              <input type="submit" name="Submit2" value="FIND TOP K DOCUMENTS" />
            </p>
          </form>
          <p align="center"></p>
        </div>
