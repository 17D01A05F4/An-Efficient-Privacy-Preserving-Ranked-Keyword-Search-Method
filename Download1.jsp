...
.style5 {font-size: 36px; color: #FF0000; font-weight: bold; }
.style6 {font-size: 24px}
.style12 {font-size: 18px; color: #FF0000; font-weight: bold; font-style: italic; }
-->
</style>
</head>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
       <h1><span class="style5"><a href="index.html" class="style5 style6">An Efficient Privacy-Preserving Ranked Keyword Search Method</a></span></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
        ...
        <div class="article">
		  ...
		  <%
            ...
            <table width="478" border="0" align="center">
              <tr>
                <td width="223"><span class="style12">Enter File Name :-</span></td>
                <td width="245"><label>
                  <input required name="t1" type="text" value="<%=file%>" size="40" />
                </label></td>
              </tr>
              <tr>
                <td height="34"><span class="style12">Trapdoor :-</span></td>
                <td><input name="t12" type="text" value="<%=trapdoor%>" size="40" /></td>
              </tr>
              <tr>
                <td><span class="style12">Secret Key :-</span></td>
